...
{
  public class OnlineLoadBalancerGroupedWithinActor : OnlineLoadBalancerBenchmarkActorBase
  {
    public OnlineLoadBalancerGroupedWithinActor(LoadBalancerSettings settings, IPcapLoader pcapLoader) : base(
      settings, pcapLoader)
    {
    }

    public new static Props Props(LoadBalancerSettings settings, IPcapLoader pcapLoader) =>
      Akka.Actor.Props.Create(() => new OnlineLoadBalancerGroupedWithinActor(settings, pcapLoader));
