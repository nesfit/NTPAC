...
namespace NTPAC.ApplicationProtocolExport.Kaitai
{
    /// <summary>
    ...
    public partial class KaitaiStream : BinaryReader
    {
        ...
        public bool IsEof
        {
            get { return this.BaseStream.Position >= this.BaseStream.Length; }
        }
        ...
        {
            return BitConverter.ToInt16(this.ReadBytesNormalisedBigEndian(2), 0);
        }
        ...
        public int ReadS4be()
        {
            return BitConverter.ToInt32(this.ReadBytesNormalisedBigEndian(4), 0);
        }
        ...
        {
            return BitConverter.ToInt64(this.ReadBytesNormalisedBigEndian(8), 0);
        }
        ...
        {
            return BitConverter.ToInt16(this.ReadBytesNormalisedLittleEndian(2), 0);
        }
        ...
        public int ReadS4le()
        {
            return BitConverter.ToInt32(this.ReadBytesNormalisedLittleEndian(4), 0);
        }
        ...
        {
            return BitConverter.ToInt64(this.ReadBytesNormalisedLittleEndian(8), 0);
        }
        ...
        {
            return BitConverter.ToUInt16(this.ReadBytesNormalisedBigEndian(2), 0);
        }
        ...
        {
            return BitConverter.ToUInt32(this.ReadBytesNormalisedBigEndian(4), 0);
        }
        ...
        {
            return BitConverter.ToUInt64(this.ReadBytesNormalisedBigEndian(8), 0);
        }
        ...
        {
            return BitConverter.ToUInt16(this.ReadBytesNormalisedLittleEndian(2), 0);
        }
        ...
        {
            return BitConverter.ToUInt32(this.ReadBytesNormalisedLittleEndian(4), 0);
        }
        ...
        {
            return BitConverter.ToUInt64(this.ReadBytesNormalisedLittleEndian(8), 0);
        }
        ...
        {
            return BitConverter.ToSingle(this.ReadBytesNormalisedBigEndian(4), 0);
        }
        ...
        {
            return BitConverter.ToDouble(this.ReadBytesNormalisedBigEndian(8), 0);
        }
        ...
        {
            return BitConverter.ToSingle(this.ReadBytesNormalisedLittleEndian(4), 0);
        }
        ...
        {
            return BitConverter.ToDouble(this.ReadBytesNormalisedLittleEndian(8), 0);
        }
        ...
        public ulong ReadBitsInt(int n)
        {
            ...
            if (bitsNeeded > 0)
            {
                ...
                byte[] buf = this.ReadBytes(bytesNeeded);
            ...
            ulong res = (this.Bits & mask) >> shiftBits;
            // clear top bits that we've just read => AND with 1s
            this.BitsLeft -= n;
            mask = GetMaskOnes(this.BitsLeft);
            this.Bits &= mask;
        ...
        public ulong ReadBitsIntLe(int n)
        {
            ...
            if (bitsNeeded > 0)
            {
                ...
                for (int i = 0; i < buf.Length; i++)
                {
                    ulong v = (ulong)(buf[i] << this.BitsLeft);
                    this.Bits |= v;
                    this.BitsLeft += 8;
                }
            }
        ...
        {
            return this.ReadBytes(this.BaseStream.Length - this.BaseStream.Position);
        }
        ...
        public byte[] ReadBytesTerm(byte terminator, bool includeTerminator, bool consumeTerminator, bool eosError)
        {
            ...
            while (true)
            {
                ...
                if (b == terminator)
                {
                    ...
                    if (!consumeTerminator) this.Seek(this.Pos - 1);
                    break;
                }
                bytes.Add(b);
            }
        ...
        {
            byte[] bytes = this.ReadBytes(expected.Length);
