...
namespace SnooperTLS.Kaitai
{
    public partial class TlsPacket : KaitaiStruct
    {
        ...
        private void _read()
        {
            _records = new List<TlsRecord>();
            {
                var i = 0;
                while (!m_io.IsEof) {
                    _records.Add(new TlsRecord(m_io, this, m_root));
                    i++;
                }
            }
        }
        ...
        public partial class TlsRecord : KaitaiStruct
        {
            ...
            public TlsRecord(KaitaiStream p__io, TlsPacket p__parent = null, TlsPacket p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _contentType = ((TlsPacket.TlsContentType) m_io.ReadU1());
        ...
        public partial class TlsChangeCipherSpec : KaitaiStruct
        {
            ...
            public TlsChangeCipherSpec(KaitaiStream p__io, TlsPacket.TlsRecord p__parent = null, TlsPacket p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private TlsPacket m_root;
            private TlsPacket.TlsRecord m_parent;
            public byte[] ChangeMessage { get { return _changeMessage; } }
            public TlsPacket M_Root { get { return m_root; } }
            public TlsPacket.TlsRecord M_Parent { get { return m_parent; } }
        }
        ...
        public partial class TlsApplicationData : KaitaiStruct
        {
            ...
            public TlsApplicationData(KaitaiStream p__io, TlsPacket.TlsRecord p__parent = null, TlsPacket p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class TlsEncryptedMessage : KaitaiStruct
        {
            ...
            public TlsEncryptedMessage(KaitaiStream p__io, TlsPacket.TlsRecord p__parent = null, TlsPacket p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class TlsHandshake : KaitaiStruct
        {
            ...
            public TlsHandshake(KaitaiStream p__io, TlsPacket.TlsRecord p__parent = null, TlsPacket p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        private List<TlsRecord> _records;
        private TlsPacket m_root;
        private KaitaiStruct m_parent;
        public List<TlsRecord> Records { get { return _records; } }
        public TlsPacket M_Root { get { return m_root; } }
        public KaitaiStruct M_Parent { get { return m_parent; } }
    }
}
